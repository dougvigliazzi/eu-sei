...
// check_captcha() Error Messages
	define('ERROR_MESSAGE_CAPTCHA',			'O c&oacute;digo deve conter caracteres');
	define('ERROR_MESSAGE_CAPTCHA_INVALID',		'C&oacute;digo inv&aacute;lido');
	define('ERROR_MESSAGE_CAPTCHA_TIMED_OUT',	'Tempo excedido '.COOKIE_TIMER.' minutes');
	define('ERROR_MESSAGE_CAPTCHA_COOKIE',		'Sem captcha cookie fornecido. Certifique que os cookies est&atilde;o habilitados.');
